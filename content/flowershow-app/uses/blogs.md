...
<div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6">
  ...
  <div className="flex lg:col-span-3 lg:row-span-1">
    <div className="w-full overflow-hidden rounded-lg bg-white outline outline-1 outline-black/5">
      <div className="p-10">
        <h3 className="mt-2 text-lg font-medium tracking-tight text-gray-900">Draft control </h3>
        <p className="mt-2 max-w-lg text-sm/6 text-gray-600">Keep unfinished posts private.  Publish when you're ready.  One frontmatter field.</p>
      </div>
    </div>
  </div>
