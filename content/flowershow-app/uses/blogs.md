...
<div className="bg-gray-50 py-12 sm:py-16">
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-8 sm:grid-cols-1">
      <a href="https://flowershow.app/blog" className="mx-auto min-w-[20rem] max-w-xl group flex flex-col rounded-2xl overflow-hidden bg-white shadow-sm ring-1 ring-gray-200/80 transition duration-200 hover:shadow-md hover:ring-[#E2BACF]">
