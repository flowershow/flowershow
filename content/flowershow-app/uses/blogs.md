...
<div className="fs-root lp-blog">
  <div id="top">
    <section className="hero">
      <div className="wrap hero-grid">
        <div className="hero-copy reveal">
          <span className="uc-badge"><span className="uc-pre">Flowershow for:</span><span className="uc-name">Blogs</span></span>
          <h1>Your personal blog. Live in seconds.</h1>
          <p className="lede">Turn your markdown notes into a blog in seconds — author profiles, comments, search, and custom domains, all built in. Then get back to writing.</p>
          <div className="cta-row">
            ...
            <a className="btn btn-secondary" href="https://demo-blog.flowershow.app/">See demo <span className="arw">→</span></a>
          </div>
          <p className="microcopy"><b>Free forever</b>, no credit card required</p>
        </div>
        <div className="hero-media reveal">
          <video className="hero-img" src="/assets/uses/blog/blog-demo.mp4" poster="/assets/uses/blog/blog-index.webp" autoPlay loop muted playsInline aria-label="A blog published with Flowershow — post index, search, and comments"></video>
        </div>
      </div>
    </section>
      ...
      <div className="wrap">
        <div className="publish-card publish-grid">
          <div className="publish-copy reveal">
            ...
            <h2>Publish from wherever you write.</h2>
            <p className="pc-sub">Pick one. Switch later — your posts are always plain markdown.</p>
            ...
            <div className="publish-agent">
              ...
              <p className="pa-copy">The Flowershow skill publishes, configures, and styles your blog — in whichever workflow you already use.</p>
          ...
          <div className="wf-grid reveal">
            <div className="wf-card">
              ...
              <h3>Obsidian</h3>
              <p>Publish your vault — author profiles, comments, and search included.</p>
            ...
            <div className="wf-card">
              ...
              <h3>Drag &amp; drop</h3>
              <p>Upload a folder of markdown in the browser and get a live blog.</p>
    ...
    <section className="section section-soft" id="features">
      <div className="wrap">
        <div className="section-head reveal">
          ...
          <h2>A real blog, out of the box.</h2>
          <p>Drop your writing in a folder — that's your blog. No setup, no CMS, no config.</p>
        </div>
        <div className="bento">
          <div className="bento-card bento-index reveal">
            <div className="bento-media bg-berry">
              <img src="/assets/uses/blog/blog-index.webp" alt="A Markdown blog index published with Flowershow" loading="lazy" />
            </div>
            <div className="bento-body">
              <h3>Beautiful blog index</h3>
              <p>One line sets up a listing of your posts — with dates, thumbnails, and descriptions. Sorted by date. Paginated if you want. No separate CMS or configuration.</p>
              <a className="ft-learn" href="/docs/list-component"><span className="lm-txt">Learn more</span> <span className="arw">→</span></a>
            </div>
          </div>
          <div className="bento-card bento-search reveal">
            <div className="bento-media bg-lemon">
              <img src="/assets/uses/blog/blog-search.webp" alt="Full-text search on a Flowershow blog" loading="lazy" />
            </div>
            <div className="bento-body">
              <h3>Search</h3>
              <p>Help readers find any post in seconds — across titles, headings, and content, even as your blog grows.</p>
          ...
          <div className="bento-card bento-comments reveal">
            <div className="bento-media bg-soft">
              <img src="/assets/uses/blog/blog-comments.webp" alt="Reader comments on a Flowershow blog" loading="lazy" />
            </div>
            <div className="bento-body">
              <h3>Comments</h3>
              <p>Readers respond via GitHub Discussions — no third-party comment service to set up or pay for.</p>
              <a className="ft-learn" href="/docs/comments"><span className="lm-txt">Learn more</span> <span className="arw">→</span></a>
            </div>
          </div>
          <div className="bento-card bento-news reveal">
            <div className="bento-body">
              <span className="bento-tag">Coming soon</span>
              <h3>Built-in newsletter</h3>
              <p>Email new posts to subscribers directly from Flowershow. No separate newsletter tool needed.</p>
            </div>
          </div>
        </div>
