...
description: "Publish a wiki or knowledge base from plain markdown. Automatic navigation, full-text search, and wiki links — all built in. Free plan forever."
layout: plain
showToc: false
showEditLink: false
showComments: false
...
<div className="fs-root lp-wiki">
  <div id="top">
    <section className="hero">
      <div className="wrap hero-grid">
        <div className="hero-copy reveal">
          <span className="uc-badge"><span className="uc-pre">Flowershow for:</span><span className="uc-name">Wikis</span></span>
          <h1>Your Markdown wiki. Live in seconds.</h1>
          <p className="lede">Turn a folder of markdown into a fast, searchable wiki — automatic navigation, full-text search, and wiki links, all built in. No setup, no config.</p>
        ...
        <div className="hero-media reveal">
          <img className="hero-img" src="/assets/uses/wikis/demo-wikis.webp" alt="A wiki built from markdown files and published with Flowershow — sidebar navigation, search, and wiki links" loading="eager" />
        </div>
      </div>
    </section>
      ...
      <div className="wrap">
        <div className="publish-card publish-grid">
          <div className="publish-copy reveal">
            ...
            <h2>Publish your wiki from wherever you write.</h2>
            ...
            <div className="publish-agent">
              ...
              <p className="pa-copy">The Flowershow skill publishes, configures, and styles your wiki — in whichever workflow you already use.</p>
          ...
          <div className="wf-grid reveal">
            <div className="wf-card">
              ...
              <h3>Obsidian</h3>
              <p>Publish your vault — wiki links, navigation, and search included.</p>
            ...
            <div className="wf-card">
              ...
              <h3>Drag &amp; drop</h3>
              <p>Upload a folder of markdown in the browser and get a live wiki.</p>
    ...
    <section className="section section-soft" id="features">
      <div className="wrap">
        <div className="section-head reveal">
          ...
          <h2>A real wiki, out of the box.</h2>
          <p>Drop your markdown files in a folder — that's your wiki. No setup, no CMS, no config.</p>
        </div>
        <div className="bento">
          <div className="bento-card bento-search reveal">
            <div className="bento-media is-mock">
              <div className="mock mk-search">
                <div className="se-box">
                  ...
                  <span className="se-q">deploy<span className="caret"></span></span>
                ...
                <div className="se-results">
                  <div className="se-row on">
                    ...
                    <div className="se-tx"><div className="st-t">Deployment</div><div className="st-s">How to <mark>deploy</mark> a build to staging and production…</div></div>
                  </div>
                  <div className="se-row">
                    <span className="se-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /></svg></span>
                    <div className="se-tx"><div className="st-t">Rollback Runbook</div><div className="st-s">Reverting a bad <mark>deploy</mark> without downtime…</div></div>
                  </div>
                  <div className="se-row">
                    <span className="se-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /></svg></span>
                    <div className="se-tx"><div className="st-t">CI Pipeline</div><div className="st-s">Every <mark>deploy</mark> runs the full test suite first…</div></div>
                  </div>
                </div>
              </div>
            </div>
            <div className="bento-body">
              ...
              <p>Readers find any page in seconds — across titles, headings, and content, even as your wiki grows past a handful of pages.</p>
          ...
          <div className="bento-card bento-comments reveal">
            <div className="bento-media is-mock">
              <div className="mock mk-wiki">
                <div className="wk-editor">See the <span className="tok-b">[[</span><span className="tok-l">Deployment</span><span className="tok-b">]]</span> guide before shipping.</div>
                <div className="wk-rendered">See the <a href="#">Deployment</a> guide before shipping.</div>
              </div>
            </div>
            <div className="bento-body">
              <h3>Wiki-style links</h3>
              <p>Connect pages with <code>[[wiki links]]</code>. They resolve automatically and every page lists what links back to it — your knowledge base cross-references itself.</p>
              <a className="ft-learn" href="/docs/reference/wikilinks"><span className="lm-txt">Learn more</span> <span className="arw">→</span></a>
            </div>
          </div>
          <div className="bento-card bento-news reveal">
            <div className="bento-body">
              <span className="bento-tag alt">GitHub Wiki, upgraded</span>
              <h3>A better alternative to GitHub Wiki</h3>
              <p>GitHub Wikis are hard to customize and can't be published as a real site. Flowershow turns the same repo into a fast, searchable wiki with beautiful navigation and zero configuration.</p>
            </div>
          </div>
        </div>
