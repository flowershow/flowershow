      ...
      <div className="wrap hero-grid">
        <div className="hero-copy reveal">
          ...
          <div className="cta-row">
            ...
            <a className="btn btn-secondary" href="https://prisca-os-saiefr.flowershow.me/">See a live garden <span className="arw">→</span></a>
          </div>
          <p className="microcopy"><b>Free forever</b>, no credit card required</p>
        </div>
        <div className="hero-media reveal">
          <img className="hero-img" src="/assets/home/garden.png" alt="A digital garden published with Flowershow — sidebar navigation and an interactive backlinks graph" fetchPriority="high" decoding="async" />
        </div>
      </div>
    </section>
