...
<div className="bg-gray-900 py-6">
  <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
    ...
    <p className="mt-1 text-sm text-gray-400">Flowershow is markdown publishing infrastructure. The Flowershow skill helps agents publish content, configure sites, and customize styling using your existing workflow — CLI, GitHub, or Obsidian.<br/><a href="https://raw.githubusercontent.com/flowershow/skills/main/SKILL.md" className="text-orange-400 hover:text-orange-300">Use the Flowershow skill →</a></p>
  </div>
</div>
