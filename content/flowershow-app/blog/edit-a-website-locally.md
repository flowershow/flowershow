...
authors:
  - Ola Rubaj
description: A step-by-step guide to editing your Flowershow website locally using Obsidian and GitHub Desktop.
---

> [!warning] This tutorial is outdated
> This tutorial was written for the self-hosted Flowershow template (Vercel + GitHub). Flowershow is now a cloud platform — no Vercel account, GitHub Desktop, or self-hosted setup is needed. For up-to-date instructions, see the [getting started guide](/docs/getting-started).
