...
indexing files into an SQLite database, extracting frontmatter data and basic JS API.
    ...
    },
    {
        id: 2,
        title: "Version 0.1.0",
        description: 'We added support for extracting and querying forward links and backlinks.',
        date: 'May 2023',
    },
    {
        id: 3,
        title: "Version 0.2.0",
        description: 'We fixed some annoying bugs and renamed package from `@flowershow/markdowndb` to just `mddb`.',
        date: 'Aug 2023',
    },
    {
        id: 4,
