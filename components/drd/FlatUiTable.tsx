...
// this component should be imported from @portajs/components package,
// but it's causing errors when building the app
// https://github.com/datopian/portaljs/issues/1058
