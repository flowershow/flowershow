...
const variantStyles = {
  solid: {
    slate:
      "bg-slate-900 text-white dark:bg-white dark:text-slate-900 hover:bg-slate-800 hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900",
