...
export default function BuiltWithFloatingButton() {
  ...
  return (
    <Link
      ...
      className="z-100 text-md fixed bottom-[16px] right-[32px] flex items-center rounded-[40px] bg-white px-3 py-2 font-title text-sm font-medium tracking-tight shadow-[0_8px_20px_0_rgba(0,0,0,.08)] sm:bottom-[32px] "
