...
export default function PricingPlans() {
  ...
  return (
    <>
      ...
      <div className="relative mx-auto mt-10 grid max-w-md grid-cols-1 gap-y-8 lg:mx-0 lg:-mb-14 lg:mb-14 lg:max-w-none lg:grid-cols-3">
        <div
          className="hidden lg:absolute lg:inset-x-px lg:bottom-0 lg:top-4 lg:block lg:rounded-t-2xl lg:bg-slate-100 lg:ring-1 lg:ring-white/10 dark:lg:bg-gray-800/80"
          aria-hidden="true"
        />
        {tiers.map((tier) => (
          <div
