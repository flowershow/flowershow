...
export default function Example() {
    return (
        <div className="divide-y divide-gray-200 overflow-hidden rounded-lg bg-gray-200 dark:bg-slate-800 shadow sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0">
                ...
                <div
                    ...
                    className={classNames(
                        ...
                        actionIdx === addOns.length - 1
                            ...
                            : "",
                        "group relative bg-white dark:bg-slate-900 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500"
                    )}
                >
                    <div>
                        <span
                    ...
                    <span
                        className="pointer-events-none absolute right-6 top-6 dark:text-gray-300 group-hover:text-gray-400"
                        aria-hidden="true"
                    >
