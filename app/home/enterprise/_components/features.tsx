        ...
        <div className="relative my-6 sm:my-8 lg:my-24">
            <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center justify-items-center">
                <div className={`max-w-lg ${align === "right" && "lg:col-start-2"}`}>
                    <h3 className="text-3xl font-semibold tracking-tight sm:text-3xl whitespace-pre-line">
                        {title}
                    </h3>
                    <p className="mt-3 text-lg opacity-75">{description}</p>
                </div>
                <div
                    className={`mt-10 -mx-4 relative lg:mt-0 ${align === "right" && "lg:col-start-1"
                        }`}
                >
                    <img className="relative mx-auto" width="400" src={image} alt={title} title={title} />
                </div>
            </div>
        </div>
    );
    ...
    return (
        <>
            <div id="features" className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:pb-12 lg:px-8 lg:grid lg:gap-x-8 text-center">
                <h3 className="text-base font-semibold text-theme-orange uppercase tracking-wide">
                    Everything you need
                </h3>
                <h2 className="mt-2 text-4xl font-semibold whitespace-pre-line">
                    Mature, Functional and Polished
                </h2>
                <p className="mt-4 text-2xl opacity-75">
